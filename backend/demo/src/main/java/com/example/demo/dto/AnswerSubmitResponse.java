...
public class AnswerSubmitResponse {
    ...
    public AnswerSubmitResponse(boolean correct, List<String> tehai, String answerTile, String doraTile, String explanation, long answerCount, double correctRate) {
